...
export function getVideoGames(){
    ...
    return async function(dispatch){
        const infoBack = await axios.get("/videogames")
...
export function getNameVgames(name){
    ...
    return async function(dispatch){
        try {
            var nameSearch = await axios.get(`/videogames?name=${name}`);
...
export function getGenres(){
    ...
    return async function(dispatch){
        var infoGenres = await axios.get("/genres");
...
export function getPlatforms(){
    ...
    return async function(dispatch){
        var infoPlatform = await axios.get("/platform");
...
export function getDetails(id){
    ...
    if(id){
        return async function(dispatch){
            try {
                const infoID = await axios.get(`/videogame/${id}`);
...
export function postVgame(payload){
    ...
    return async function(dispatch){
        ...
        const infoGame = await axios.post('/videogames', payload);
